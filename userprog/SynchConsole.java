...
public class SynchConsole {
    ...
    public SynchConsole(SerialConsole console) {
    	...
    	Runnable receiveHandler = new Runnable() {
    	    public void run() { receiveInterrupt(); } // After input interrupt response
    	};
    	Runnable sendHandler = new Runnable() {
    	    public void run() { sendInterrupt(); }  // After output interrupt response
    	};
    ...
    private void sendInterrupt() {
	       writeWait.V(); // after insterrupt output
    }
